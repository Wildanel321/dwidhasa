  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark-100">
      <div className="container mx-auto px-6 py-8">
        <Link to="/" className="inline-flex items-center gap-2 px-4 py-2 bg-brutalist-yellow border-2 border-black font-bold uppercase shadow-brutalist hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all mb-8">
